...
import com.mario.web.support.exception.WebExceptionResolver;
import com.mario.web.support.interceptor.SerialNoInitInterceptor;
import com.mario.web.support.mvc.CustomServletModelAttributeMethodProcessor;
import com.mario.web.support.validator.CustomValidatorFactoryBean;
...
/**
 * Created with IntelliJ IDEA. User: qiujingwang Date: 2018-03-24 Description:
 */
...
//        registry.addResourceHandler("/js/**").addResourceLocations("/js/").setCachePeriod(31556926).resourceChain(true).addResolver(new GzipResourceResolver());
  ...
  public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
    ...
    HttpMessageConverters httpMessageConverters = new HttpMessageConverters(addDefault,
        getConverters());
  ...
  public void addInterceptors(InterceptorRegistry registry) {
    MappedInterceptor serialNoInitInterceptor = new MappedInterceptor(new String[]{"/**"},
        new String[]{"/error/403", "/error/404", "/error/405"},
        new SerialNoInitInterceptor(AppName.DISCOVER));
  ...
  public void addFormatters(FormatterRegistry registry) {
    ...
    defaultFormattingConversionService.setEmbeddedValueResolver(new EmbeddedValueResolver(
