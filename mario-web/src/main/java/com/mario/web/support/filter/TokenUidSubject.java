...
/**
 * Created with IntelliJ IDEA. User: qiujingwang Date: 2017/4/6 Description:
 */
@Slf4j
  ...
  public boolean isAuthenticated() {
    if (authenticated == null) {
      if (StringUtil.isNotBlank(token)) {
        ...
        authenticated = false;
        try {
          CommonResponse<TokenDataBasicResponse> commonResponse = UserAccessTokenManager
              .accessTokenValidate(validationRequest);
