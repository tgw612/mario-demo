...
//                .enable(enableRestApi)
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder()
        ...
        .contact(
            new Contact("TAPD", "https://www.tapd.cn/62061237/prong/iterations/card_view", null))
        .version(version)
        .build();
  }
  ...
  public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
    if (beanName.equals("swagger2ControllerMapping")) {
      ((PropertySourcedRequestMappingHandlerMapping) bean)
          .setOrder(Ordered.LOWEST_PRECEDENCE - 1000);
  ...
  private Set<String> getSwagger2SecurityExcludesUrls() {
    ...
    return Arrays.stream(
        new String[]{"/swagger-resources", "/swagger-resources/*", Swagger2Controller.DEFAULT_URL,
            "/csrf", "/webjars/*", "/swagger-ui.html"}).collect(Collectors.toSet());
  }
}
