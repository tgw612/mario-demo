...
/**
 * Created with IntelliJ IDEA. User: qiujingwang Date: 2018-03-28 Description:
 */
@Slf4j
public class WebExceptionResolver extends AbstractHandlerMethodExceptionResolver {
  ...
  public WebExceptionResolver(HttpMessageConverter<Object> messageConverter,
      WebExceptionHandler webExceHandler) {
    this.messageConverter = messageConverter;
  ...
  protected ModelAndView doResolveHandlerMethodException(HttpServletRequest request,
    ...
    try {
      ...
      log.error(
          "Failed to invoke HandlerMethodException: {}, outputValue:{}, WebExceptionResolverException:{}, SystemException:{}",
          handlerMethod, outputValue, ExceptionUtil.getAsString(e), ExceptionUtil.getAsString(ex));
