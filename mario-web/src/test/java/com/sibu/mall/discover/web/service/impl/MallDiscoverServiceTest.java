...
import com.mall.discover.web.service.base.BaseSpringTest;
...
public class MallDiscoverServiceTest extends BaseSpringTest{
    ...
    public void testPageDiscover() throws Exception {
        ...
        CommonResponse<CommonPageResult<MemberDiscoverResponse>> discover = mallDiscoverService.pageDiscover(request);
