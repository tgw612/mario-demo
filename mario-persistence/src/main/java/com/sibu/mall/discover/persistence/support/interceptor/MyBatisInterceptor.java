package com.mall.discover.persistence.support.interceptor;
...
public class MyBatisInterceptor implements Interceptor {
    ...
    private final static Pattern ORACLE_PATTERN = Pattern.compile(ORACLE_REGEX, Pattern.CASE_INSENSITIVE);
...
//        String countSql = "select count(0)  as total from (" + sql + ") T";
    ...
    private void setParameters(PreparedStatement ps, MappedStatement mappedStatement, BoundSql boundSql,
        ...
        ParameterHandler parameterHandler = new CustomDefaultParameterHandler(mappedStatement, parameterObject, boundSql);
    ...
    public StringBuilder buildPageSqlForOracle(String sql, PageParameter page) {
        ...
        pageSql.append("SELECT ").append(targetCols).append(" FROM (select ").append(targetCols).append(",  ROWNUM ROWNUM_ from ( ");
        pageSql.append(sql);
        pageSql.append(" ) temp ");
