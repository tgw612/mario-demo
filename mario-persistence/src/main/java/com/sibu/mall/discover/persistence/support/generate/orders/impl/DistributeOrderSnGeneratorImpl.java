package com.mall.discover.persistence.support.generate.orders.impl;


import com.doubo.common.interfaces.StringHashCoding;
import com.mall.common.utils.SeqGenUtil;
import com.mall.discover.persistence.support.generate.orders.OrderSnGenerator;
import com.mall.discover.persistence.support.generate.orders.OrderSnResolver;
...
public class DistributeOrderSnGeneratorImpl implements OrderSnGenerator, OrderSnResolver {
    ...
    /**
     * 生成主订单号
     * A + OrderCode +【两位32进制订单数据定位符，根据会员id定位】
     * 例子：A201807061153000001FFFF
     *
     * @return
     */
    @Override
    ...
    /**
     * 生成子订单号
     * B+ OrderCode +【两位32进制订单数据定位符，根据会员id定位】
     * 例子：B201807061153000001FFFF
     *
     * @return
     */
    @Override
    ...
    public static void main(String args[]){
        ...
        //要考虑 不足两位时，补位的左边 补位的0
        String localIndex = "A1810161406291221184740JV".substring("A1810161406291221184740JV".length() - 2);
        String left = localIndex.substring(0, 1);
        String right = localIndex.substring(1);
