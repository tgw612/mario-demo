...
/**
 * Created with IntelliJ IDEA. User: qiujingwang Date: 2018-03-15 Description:
 */
@Configuration
...
public class PersistenceConfig {
  ...
  public StringHashCoding dataBaseHashCoding() {
    StringConsistentHashCoding dataBaseHashCoding = new StringConsistentHashCoding(
        appConfig.getShardingRealCount(), appConfig.getShardingVirtualCount());
    //设置静态分库负载算法
  ...
  public StringHashCoding tableHashCoding() {
    StringConsistentHashCoding tableHashCoding = new StringConsistentHashCoding(
        appConfig.getShardingVirtualCount(), appConfig.getShardingRealCount());
    //设置静态分表负载算法
