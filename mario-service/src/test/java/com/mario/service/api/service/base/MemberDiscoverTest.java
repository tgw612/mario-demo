package com.mario.service.api.service.base;
...
public class MemberDiscoverTest extends BaseSpringTest {
  ...
  public void pageDiscoverTest() {
    ...
    CommonResponse<CommonPageResult<MemberPageQueryDiscoverListResponse>> pageResultCommonResponse = memberDiscoverBiz
        .pageDiscover(memberPageQueryDiscoverListRequest);
  }
