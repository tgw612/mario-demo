...
package com.mario.service.api.config.properties;

import java.time.Duration;
import java.util.List;
import org.springframework.boot.context.properties.ConfigurationProperties;

@ConfigurationProperties(prefix = "discover.redis")
public class DiscoverRedisProperties {
  ...
  public static class Pool {
    ...
    /**
     * Maximum number of "idle" connections in the pool. Use a negative value to indicate an
    ...
    /**
     * Maximum number of connections that can be allocated by the pool at a given time. Use a
     ...
     * the pool is exhausted. Use a negative value to block indefinitely.
     */
