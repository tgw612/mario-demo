...
public class AdminDiscoverBiz {
  ...
  public CommonResponse<CommonPageResult<AdminPageDiscoverListResponse>> listPage(
      AdminPageDiscoverListRequest request) {
    try {
      ...
      List<AdminPageDiscoverListResponse> datas = BeanCopyUtils
          .copyList(AdminPageDiscoverListResponse.class, memberDiscoverEntityList);
  ...
  public CommonResponse<List<AdminDiscoverListCateResponse>> listCate(
      AdminDiscoverListCateRequest request) {
    try {
      Map queryMap = BeanUtils.describe(request);
      ...
      List<AdminDiscoverListCateResponse> datas = BeanCopyUtils
          .copyList(AdminDiscoverListCateResponse.class, cateEntityList);
  ...
  public CommonResponse<CommonPageResult<AdminDiscoverListCateResponse>> listCatePage(
      AdminDiscoverListCateRequest request) {
    try {
      Map queryMap = BeanUtils.describe(request);
      queryMap.put("pageSize", request.getPageSize());
      ...
      List<AdminDiscoverListCateResponse> datas = BeanCopyUtils
          .copyList(AdminDiscoverListCateResponse.class, cateEntityList);
      return ResponseManage.success(ConverterUtil.convertToPageResult(datas, count,
          ConverterUtil.calculateTotalPage(request.getPageSize(), count.intValue())));
    } catch (Exception e) {
      log.error("[{}]分页查询动态失败, Exception:{}", SerialNo.getSerialNo(), ExceptionUtil.getAsString(e));
    }
  ...
  public CommonResponse<Boolean> add(AdminDiscoverAddRequest request) {
    try {
      MemberDiscoverEntity entity = BeanCopyUtils
  ...
  public CommonResponse<AdminDiscoverDetailResponse> detail(AdminDiscoverDetailRequest request) {
    ...
    AdminDiscoverDetailResponse response = BeanCopyUtils
        .copyProperties(AdminDiscoverDetailResponse.class, item);
  ...
  public CommonResponse<Boolean> addCate(AdminDiscoverCateAddCateRequest request) {
    try {
      MemberDiscoverCateEntity entity = BeanCopyUtils
  ...
  public CommonResponse<AdminDiscoverCateFindCateByIdResponse> findCateById(
      AdminDiscoverCateFindCateByIdRequest request) {
    MemberDiscoverCateEntity item = adminDiscoverDao.findCateById(request.getId());
    AdminDiscoverCateFindCateByIdResponse response = BeanCopyUtils
        .copyProperties(AdminDiscoverCateFindCateByIdResponse.class, item);
    return ResponseManage.success(response);
  }
