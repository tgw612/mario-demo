...
import com.mall.discover.config.properties.DiscoverRedisProperties;
...
@Configuration
@EnableMethodCache(basePackages = "com.mall.discover.service.impl.biz")
...
public class JetCacheConfig {
    ...
    private RedisLettuceCacheBuilder createDiscoverRemoteCache(){
        RedisLettuceCacheBuilder hPageRemoteCacheBuilder = RedisLettuceCacheBuilder.createRedisLettuceCacheBuilder()
