...
public class ClientArticleBiz {
     ...
     *  获取文章列表
     */
    public List<ArticleBO> queryArticlePage(ClientArticlePageRequest request, List<Integer> articleLookTypeList) {
        //固定每页大小
        ...
        //查询文章列表
        return clientArticleMapper.queryArticleList(articleVo, PageUtils.getStartPage(request), request.getPageSize());
    }
    ...
    public boolean updateArticleLookType() {
        ...
        for (ArticleBO articleBO : articleBOS) {
            ...
            ArticleLook articleLook = DiscoverUtil.convertStringResponse(articleBO.getArticleLook(), ArticleLook.class);
