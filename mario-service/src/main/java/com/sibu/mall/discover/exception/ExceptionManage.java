package com.mall.discover.exception;
 ...
 * 2.ValidationException 校验异常；<br/>
 * 3.RpcException Dubbo超时异常；<br/>
 * 4.Exception 其他异常。<br/>
 */
public class ExceptionManage {
    ...
    public static CommonResponse exceptionResult(Throwable throwable){
        if(throwable instanceof IllegalArgumentException){
            ...
            //调用者必须要记录日志
            return ResponseManage.fail(ErrorCodeEnum.BEAN_BIZ_ERROR.getErrorCode(), throwable.getMessage());
        }
    }
